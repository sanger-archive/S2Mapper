define([
  ...
  var searches = BaseResource.extendAs(['laboratorySearch', 'supportSearch']);
  ...
  return _.map(searches,function(SearchResource){
      ...
      handling: function(resultModel) {
        ...
        function searchHandler(actionName, indexOnPage){
          ...
          return function(options){
            ...
            root[SearchResource.resourceType.pluralize()].create(options)
